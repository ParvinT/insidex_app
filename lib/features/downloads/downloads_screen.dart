  ...
  class _DownloadsScreenState extends State<DownloadsScreen> {
    ...
    Future<void> _playDownload(DownloadedSession download) async {
      // Create session data from download
      final sessionData = {
        'id': download.sessionId,
        'title': download.title,
        'sessionNumber': download.sessionNumber,
        'categoryId': download.categoryId,
        'categoryName': download.categoryName,
        'description': download.description,
        '_isOffline': true,
        '_downloadedLanguage': download.language,
      };

      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => AudioPlayerScreen(sessionData: sessionData),
        ),
      );
    }
